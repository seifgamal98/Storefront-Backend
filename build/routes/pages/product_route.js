...
var ProductsModelnew = new productmodel_1.ProductsModel();
routes.post('/', authmiddleware_1.default, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductsModelnew.create(req.body)];
            case 1:
                product = _a.sent();
                res.json({
...
routes.get('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductsModelnew.index()];
            case 1:
                Allproducts = _a.sent();
                res.json({
...
routes.get('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Oneproduct, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductsModelnew.show(req.params.id)];
            case 1:
                Oneproduct = _a.sent();
                res.json({
                    data: { Oneproduct: Oneproduct },
...
routes.delete('/:id', authmiddleware_1.default, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Deletedproduct, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductsModelnew.delete(req.params.id)];
            case 1:
...
routes.patch('/:id', authmiddleware_1.default, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductsModelnew.update(req.body)];
            case 1:
