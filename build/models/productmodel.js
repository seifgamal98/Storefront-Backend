        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sqlQuery = "INSERT INTO products(name,price) VALUES ($1,$2) RETURNING id,name,price";
                        return [4 /*yield*/, conn.query(sqlQuery, [product.name, product.price])];
                    case 2:
                        output = _a.sent();
                        conn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable to view all the products ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sqlQuery = "SELECT id,name,price FROM products WHERE id=($1)";
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable to view this product ".concat(id, " ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductsModel.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sqlQuerystar = "DELETE FROM products WHERE id=($1) RETURNING *";
                    ...
                    case 7:
                        err_4 = _a.sent();
                        throw new Error("Unable to delete this product ".concat(id, " ").concat(err_4));
                    case 8: return [2 /*return*/];
                }
            });
        });
    };
    ProductsModel.prototype.update = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sqlQuery = "UPDATE products SET price=$1,name=$2 WHERE id=$3 RETURNING *";
                        sqlQuery_ = 'ALTER SEQUENCE productorder_id_seq RESTART WITH 1;';
                        sqlQuery11 = 'ALTER SEQUENCE products_id_seq RESTART WITH 1;';
                        sqlQuery22 = 'ALTER SEQUENCE orders_id_seq RESTART WITH 1;';
                        sqlQuery33 = 'ALTER SEQUENCE users_id_seq RESTART WITH 1;';
                    ...
                    case 7:
                        err_5 = _a.sent();
                        throw new Error("Unable to update this user ".concat(err_5));
                    case 8: return [2 /*return*/];
                }
            });
        });
